...
class Solution {
    ...
    private int getkfromtwo(int[] nums1, astart, int[] nums2,bstart, k){
        ...
        if(mida<midb) return getkfromtwo(nums1, astart+k/2, num2, bstart, k-k/2);
        else return getkfromtwo(nums1, astart, num2, bstart+k/2, k-k/2);
    }
}
